...
val md_theme_light_secondaryContainer = Color(0xFFF8EDEF) // dialogs, decks, etc.
...
val md_theme_light_surfaceVariant = Color(0xFFF8EDEF) // compose card default background
...
val md_theme_light_inversePrimary = Color(0xFFF8EDEF)
val md_theme_light_surfaceTint = Color(0xFFF8EDEF)
val md_theme_light_outlineVariant = Color(0xFFF8EDEF)
